...
DB schema per package:
{
  "wget": {
    "versions": {
      "1.21.4": {"keg": "...", "installed_at": "...", "sha256": "..."},
      "1.21.3": {"keg": "...", "installed_at": "...", "sha256": "..."}
    },
...
def _exclusive_lock():
    """Hold an exclusive advisory lock on a per-db lock file for the duration."""
    config.db_path.parent.mkdir(parents=True, exist_ok=True)
    lock_path = config.db_path.with_suffix(".lock")
...
def record_install(name: str, version: str, keg: Path, sha256: str = ""):
